...
public class InventorySystem {
    ...
    public boolean addNewStock(LocalDate dateEntered, String stockLabel, String brand, String engineNumber, String status) {
        ...
        // Rebuild the StockBST (this can be an optional step if you want to ensure the tree is always updated)
        rebuildTreeFromList();
